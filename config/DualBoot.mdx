...
1. Create a bootable USB with the ISO using [Rufus](https://rufus.ie/en/). Open Rufus, select the MASQ ISO and your USB, then click next. Be sure to choose 'Write in DD Mode' (this step is crucial).

![Rufus](/screenshots/screenshot4.jpeg)
...
![Partitioning](/screenshots/screenshot3.jpeg)
